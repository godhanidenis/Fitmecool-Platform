            ...
            {productsFiltersReducer.productLayout === "list" && (
              <>
                <div className="mt-4">
                  ...
                  <span className="text-[#565f66] text-base mt-2 line-clamp-6">
                  ...
                  <Link href={`/product/${product.id}`} passHref>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <button className="flex text-colorWhite text-base px-4 py-2 my-2 container bg-colorPrimary rounded-md whitespace-nowrap">
                        See Details
                      </button>
                    </a>
                  </Link>
